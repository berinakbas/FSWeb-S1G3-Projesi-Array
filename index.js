...
console.log("Gorev 5 :" + indekstekiCesitiGetir(orijinalTatlar,6));
...
function ismeGoreCesitCikar(dizi,cesit){
  /*kod buraya*/
...
function ismeGoreFiltrele(dizi,cesit){
  /*kod buraya*/
  const newArray=[];
  for(let i=0;i<dizi.length;i++){
    if(dizi[i].includes(cesit)){
